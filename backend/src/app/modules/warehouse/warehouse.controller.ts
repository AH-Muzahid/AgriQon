...
const getWarehouseById = catchAsync(async (req: AuthRequest, res: Response) => {
  ...
  const result = await warehouseService.getWarehouseById(req.params.id, businessId);
...
const updateWarehouse = catchAsync(async (req: AuthRequest, res: Response) => {
  ...
  const result = await warehouseService.updateWarehouse(req.params.id, businessId, req.body);
